...
function Article({article}:Props) {
  ...
  return (
    <article className=" bg-slate-100  flex flex-col rounded-lg hover:scale-105 hover:shadow-lg hover:bg-slate-200 transition-all duration-200 ease-out shadow-lg">
